...
<html lang="en">
  ...
  <body>
    <nav>
      ...
      <ul class="nav__links">
        <li class="link">Home</a></li>
       
        <li class="link"><a href="Service.php">Service</a></li>
        <li class="link"><a href="AboutUs.php">About</a></li>
        <li class="link"><a href="community.php">Community</a></li>
        <li class="link"><a href="timing.php">Timing</a></li>
      </ul>
      <button class="btn"><a href="main.php">Join Now</a></button>
    </nav>
    ...
    <header class="section__container header__container">
      <div class="header__content">
        ...
        <button class="btn"><a href="https://www.youtube.com/@fitnesszone1973/featured">Get Started</a></button>
      </div>
    ...
    <section class="section__container class__container">
      ...
      <div class="class__content">
        ...
        <button class="btn"> <a href="main.php">Book A Class</a></button>
      </div>
    </section>
    ...
    <section class="section__container price__container">
      ...
      <div class="price__grid">
        <div class="price__card">
          ...
          <button class="btn price__btn"><a href="onlinepayment.php">Join Now</a></button>
        </div>
        <div class="price__card">
          <div class="price__card__content">
            <h4>Weekly Plan</h4>
    ...
    <footer class="section__container footer__container">
      ...
      <div class="footer__col">
        <h4>Contact</h4>
        <a href="privacy.php">Contact Us</a>
        <a href="privacy.php">Privacy Policy</a>
        <a href="community.php">Terms & Conditions</a>
